describe('Blog app', function() {
  beforeEach(function () {
    ...
    cy.request({
      ...
      body: {
        username: 'cypress', name: 'Cypress Tests', password: 'cypress123'
      }
    })
    cy.request({
      url: 'http://localhost:3003/api/users',
      ...
      headers: { 'Content-Type': 'application/json' },
      body: {
        username: 'cypress2', name: 'Cypress Tests', password: 'cypress123'
      }
    }).then(() => {
      cy.visit('')
    })
  ...
  describe('When logged in', function () {
    beforeEach(function () {
      cy.request({
        ...
        headers: { 'Content-Type': 'application/json' },
        body: {
          username: 'cypress', password: 'cypress123'
        }
      }).then((response) => {
    ...
    it('A blog can be created', function () {
      ...
      cy.get('.success').contains('A new blog Cypress Test Blog by Cypress Tests added')
    ...
    it('A blog can be deleted', function () {
      ...
      cy.get('.success').contains('A blog Cypress Test Blog by Cypress Tests removed')
